...
Open PowerShell in any folder where you want to store the repository. The
downloader does not require OneDrive.
...
The following command stores the environment under your local Windows profile,
separate from the repository and any optional cloud-synced folders:
